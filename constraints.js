...
var _user$project$ConstraintsExample$num = F2(
	function (attr, value) {
		return attr(
			_elm_lang$core$Basics$toString(value));
	});
var _user$project$ConstraintsExample$background = A2(
	...
	{ctor: '[]'});
var _user$project$ConstraintsExample$guidelineStyle = F2(
	function (isEnabled, otherAttributes) {
		var color = isEnabled ? 'black' : '#ccc';
		var attributes = {
			ctor: '::',
...
var _user$project$ConstraintsExample$Model = F5(
	function (a, b, c, d, e) {
		return {position: a, drag: b, dragHorizontally: c, dragVertically: d, isDragging: e};
	});
var _user$project$ConstraintsExample$Size = F2(
	function (a, b) {
		return {width: a, height: b};
	});
var _user$project$ConstraintsExample$sceneSize = A2(_user$project$ConstraintsExample$Size, 9999, 9999);
var _user$project$ConstraintsExample$horizontalGuideline = F2(
	function (y, isEnabled) {
		return A2(
			_elm_lang$svg$Svg$g,
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A2(_user$project$ConstraintsExample$num, _elm_lang$svg$Svg_Attributes$x, 20),
						_1: {
							ctor: '::',
							_0: A2(_user$project$ConstraintsExample$num, _elm_lang$svg$Svg_Attributes$y, y),
							_1: {
								ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						A2(
							_user$project$ConstraintsExample$guidelineStyle,
							isEnabled,
							{
								ctor: '::',
								_0: A2(_user$project$ConstraintsExample$num, _elm_lang$svg$Svg_Attributes$x1, 25),
								_1: {
									ctor: '::',
									_0: A2(_user$project$ConstraintsExample$num, _elm_lang$svg$Svg_Attributes$x2, _user$project$ConstraintsExample$sceneSize.width),
									_1: {
										ctor: '::',
										_0: A2(_user$project$ConstraintsExample$num, _elm_lang$svg$Svg_Attributes$y1, y),
										_1: {
											ctor: '::',
											_0: A2(_user$project$ConstraintsExample$num, _elm_lang$svg$Svg_Attributes$y2, y),
											_1: {ctor: '[]'}
										}
									}
								}
...
var _user$project$ConstraintsExample$verticalGuideline = F2(
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A2(_user$project$ConstraintsExample$num, _elm_lang$svg$Svg_Attributes$x, x),
						_1: {
							ctor: '::',
							_0: A2(_user$project$ConstraintsExample$num, _elm_lang$svg$Svg_Attributes$y, 20),
							_1: {
								ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						A2(
							...
							{
								ctor: '::',
								_0: A2(_user$project$ConstraintsExample$num, _elm_lang$svg$Svg_Attributes$x1, x),
								_1: {
									ctor: '::',
									_0: A2(_user$project$ConstraintsExample$num, _elm_lang$svg$Svg_Attributes$x2, x),
									_1: {
										ctor: '::',
										_0: A2(_user$project$ConstraintsExample$num, _elm_lang$svg$Svg_Attributes$y1, 25),
										_1: {
											ctor: '::',
											_0: A2(_user$project$ConstraintsExample$num, _elm_lang$svg$Svg_Attributes$y2, _user$project$ConstraintsExample$sceneSize.height),
											_1: {ctor: '[]'}
										}
									}
								}
...
var _user$project$ConstraintsExample$boxSize = A2(_user$project$ConstraintsExample$Size, 60, 60);
var _user$project$ConstraintsExample$SetDragging = function (a) {
	return {ctor: 'SetDragging', _0: a};
};
var _user$project$ConstraintsExample$SetDragVertically = function (a) {
	return {ctor: 'SetDragVertically', _0: a};
};
var _user$project$ConstraintsExample$SetDragHorizontally = function (a) {
	return {ctor: 'SetDragHorizontally', _0: a};
};
var _user$project$ConstraintsExample$OnDragBy = function (a) {
	return {ctor: 'OnDragBy', _0: a};
};
var _user$project$ConstraintsExample$dragConfig = _user$project$Draggable$customConfig(
	{
		ctor: '::',
		_0: _user$project$Draggable_Events$onDragBy(_user$project$ConstraintsExample$OnDragBy),
		_1: {
			ctor: '::',
			...
			_1: {
				...
				_0: _user$project$Draggable_Events$onDragEnd(
					_user$project$ConstraintsExample$SetDragging(false)),
				_1: {ctor: '[]'}
			}
		}
	});
...
var _user$project$ConstraintsExample$DragMsg = function (a) {
...
var _user$project$ConstraintsExample$box = F2(
	function (position, isDragging) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: A2(_user$project$ConstraintsExample$num, _elm_lang$svg$Svg_Attributes$width, _user$project$ConstraintsExample$boxSize.width),
				_1: {
					ctor: '::',
					_0: A2(_user$project$ConstraintsExample$num, _elm_lang$svg$Svg_Attributes$height, _user$project$ConstraintsExample$boxSize.height),
					_1: {
						ctor: '::',
						_0: A2(_user$project$ConstraintsExample$num, _elm_lang$svg$Svg_Attributes$x, x),
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$cursor(cursor),
								_1: {
									ctor: '::',
...
var _user$project$ConstraintsExample$handleKey = F2(
	function (pressed, code) {
		...
		switch (_p12.valueOf()) {
			...
			case 'W':
				return _user$project$ConstraintsExample$SetDragVertically(!pressed);
			default:
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_0: _elm_lang$keyboard$Keyboard$downs(
				_user$project$ConstraintsExample$handleKey(true)),
			_1: {
				ctor: '::',
...
var _user$project$ConstraintsExample$main = _elm_lang$html$Html$program(
	{init: _user$project$ConstraintsExample$init, update: _user$project$ConstraintsExample$update, subscriptions: _user$project$ConstraintsExample$subscriptions, view: _user$project$ConstraintsExample$view})();

var Elm = {};
Elm['ConstraintsExample'] = Elm['ConstraintsExample'] || {};
if (typeof _user$project$ConstraintsExample$main !== 'undefined') {
    _user$project$ConstraintsExample$main(Elm['ConstraintsExample'], 'ConstraintsExample', undefined);
}
